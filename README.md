...
- **Group**: group3
- **Course**: higher certificate in mobile application and web developmesnt
- **Subject**: introduction to mobile application development 

## Links
- **GitHub Repository**: https://github.com/ST1047786/manaagement-Calculator.git
```
...
The Management Calculator is a mobile application developed as part of an ICE-TASK in the IMAD5112 subject. This application was created using **Kotlin** and **Android Studio**. The app's primary purpose is to ask the user to select materials asnd task types ,input the number of hours to work, and then calculate the total cost based on the selectios.

The app was developed to meet the requirements of the ICE-TASK, which includes creating a functional mobile app and utilizing GitHub for version control and CI/CD automation using GitHub Actions.
```

Why:
----
- this is to help carpenters keep track of cost
...
### Purpose:
The main goal of this app is to help carpenters keep track of cost


### Key Features:
- Feature 1: Easy user interface 
- Feature 2: Answer able to be displayed at the bottom of the screen
- Feature 3: Design is easy for ther user to look at and relate 
...
The design of the Management Calculator  was based on the following key considerations:
